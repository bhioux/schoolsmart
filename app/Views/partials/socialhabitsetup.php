    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="row inv--head-section justify-content-md-center">
            <!-- <div class="col-lg-8 col-offset-2"> -->
                ...
                <div class="col-lg-6">
                <h3 class="in-heading">SOCIAL HABIT SETUP</h3>
                <br>
            ...
            <div class="invoice-container">
                <div class="invoice-inbox">
                    ...
                    <div class="inv-not-selected">
                        <p>Select a class from above to setup the Social Habit.</p>
                    </div>
                                ...
                                <div class="row inv--product-table-section">
                                    <div class="col-lg-5">
                                        ...
                                        <div class="table table-hover">
                                            <table id="assessment1" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th width="50%" scope="col">Social Habit</th>
                                    ...
                                    <div class="col-lg-7 border-left">
                                        <div class="main-container sidebar-closed sbar-open" id="container">
                                            ...
                                            <h3 style="margin-bottom: 20px;">Students Social Habit Score List</h3>
