    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="row inv--head-section justify-content-md-center">
            <!-- <div class="col-lg-8 col-offset-2"> -->
                ...
                <div class="col-lg-6">
                <h3 class="in-heading">PRIZES & AWARDS SETUP</h3>
                <br>
            ...
            <div class="invoice-container">
                <div class="invoice-inbox">
                    ...
                    <div class="inv-not-selected">
                        <p>Select a class from above to setup the Prizes and Awards.</p>
                    </div>
                                ...
                                <div class="row inv--product-table-section">
                                    <div class="col-lg-5">
                                        ...
                                        <div class="table table-hover">
                                            <table id="assessment1" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th width="40%" scope="col">Awards/Prizes</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Value of Award:</td>
                                                        <td class="text-right"><input type="text" id="row-1-ass1" name="row-1-ass1" class="form-control"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Name of Prizes:</td>
                                                        <td class="text-right"><input type="text" id="row-1-ass1" name="row-1-ass1" class="form-control"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>Next Semester Begins</td>
                                                        <td class="text-right"><input type="text" id="row-1-ass1" name="row-1-ass1" class="form-control"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Next Semester Ends</td>
                                                        <td class="text-right"><input type="text" id="row-1-ass1" name="row-1-ass1" class="form-control"></td>
                                                    </tr> -->
                                                </tbody>
                                                <tfoot>
                                                    <tr>
                                                        <th width="40%" scope="col">Titles</th>
                                                        <th width="60%" scope="col"></th>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        ...
                                        <div class="col text-right">
                                            <button class="btn btn-primary mb-4 mr-2 btn-lg">Save Comments</button>
                                        </div>
                                    ...
                                    <div class="col-lg-7 border-left">
                                        <div class="main-container sidebar-closed sbar-open" id="container">
                                            ...
                                            <h3 style="margin-bottom: 20px;">Gradebook Comments List</h3>
                                        ...
                                        <div class="table table-hover">
                                            <table id="assessment1" style="width:100%">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Name of Award:</td>
                                                        <td class="text-right"><input type="text" id="awardname" name="awardname" class="form-control"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Value of Award:</td>
                                                        <td class="text-right"><input type="text" id="awardvalue" name="awardvalue" class="form-control"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Name of Prizes:</td>
                                                        <td class="text-right"><input type="text" id="prizename" name="prizename" class="form-control"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Value of Prizes:</td>
                                                        <td class="text-right"><input type="text" id="prizevalue" name="prizevalue" class="form-control"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Head Teacher's Name</td>
