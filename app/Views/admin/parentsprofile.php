  ...
  <script type="text/javascript">
    /****************UTILITY FUNCTIONS****************************8*/
        ...
        function editaction(obj){
            ...
            //alert(obj.title)
            $.post({
                url:'<?php echo site_url('admin/getrecord/parentsprofile'); ?>',
                data: { 'recordid': obj.title, 'colname': 'parentsprofileid' },
                type:'POST',
                dataType: 'json',
                success: function( json ) {
                    ...
                    */            
                    ...
                    /************Load New values*******************/
                    $("#studentprofileid").val(json.formarray.parentsprofileid);
                    $("#recordid").val(json.formarray.parentsprofileid);
                    $("#colname").val("parentsprofileid");
                    /***********************************************/
  ...
  <body class="az-body az-body-sidebar">
    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="az-content-body">
          ...
          <h4 class="az-content-title text-right">Parents Profile Form</h4>
