...
/*********************START DATATABLE CONFIGURATION***********************/
   var resulttable = $('#stprofiletable').DataTable( {
      ...
      ajax: {
          url: '<?php echo site_url('admin/datatablerecord/staffprofile'); ?>',
          dataSrc: 'staffprofile'
      },
      columns: [
          {data: "staffprofileid" },
          { 
  ...
  $("#btnsubmit").click(function(e){                
    ...
    alert(btnvalue);
    if(btnvalue=='add'){
        var targeturl = "<?php echo site_url('admin/postrecord/staffprofile'); ?>"
        var btntext = "Submit";
        ...
        var targeturl = "<?php echo site_url('admin/updaterecord/staffprofile'); ?>"
        var btntext = "Update";
        var recordid = $("#staffprofileid").val();
  ...
  $('#resulttable').on('click', '.lnkdelete', function(e){
    ...
    $.post( "<?php echo site_url('admin/deleterecord/staffprofile'); ?>", { 'recordid': recordid, 'colname':'staffprofileid'})
        .done(function( data ) {
            //alert(data)
            if(data == 1){
                resulttable.ajax.reload();
