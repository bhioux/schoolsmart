  ...
  <script type="text/javascript">
    /****************UTILITY FUNCTIONS****************************8*/
        ...
        function editaction(obj){
            ...
            //alert(obj.title)
            $.post({
                url:'<?php echo site_url('admin/getrecord/studentprofile'); ?>',
                data: { 'recordid': obj.title, 'colname': 'studentprofileid' },
                type:'POST',
                dataType: 'json',
                success: function( json ) {
                    ...
                    /*
                      `studentprofileid`, `surname`, `firstname`, `homeaddress`, `telephone`, `sex`, `dob`, `placeofborth`, `ethnicity`, `religion`, `weight`, `height`, `physicalchallenge`, `bloodtype`, genotype, `illnesssuffered`, `allergies`, `distancetoschool`, `guardianname`, `guardianrelationship`, `guardianoccupation`, `guardiangrade`, `guardianaddress`, `guradiantelephone`, `prevacadrecords`, `prevschool`, `leavingdate`, `grades`, `results`, `observation`, `currentgrade`, `refdate`
                    */            

                    /************Load New values*******************/
                    $("#studentprofileid").val(json.formarray.studentprofileid);
                    $("#recordid").val(json.formarray.studentprofileid);
                    $("#colname").val("studentprofileid");
                    /***********************************************/
                    ...
                    $('#guardianname option[value="' + json.formarray.guardianname + '"]').prop('selected','selected').val(json.formarray.guardianname).change();
                    
                    if(json.formarray.studentprofileid != ''){
    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="az-content-body">
          <div class="az-content-breadcrumb">
            <span>Forms</span>
            <span>Student Profile Form</span>
          </div>
          <h4 class="az-content-title text-right">Student Profile Form</h4>
